(function ($) {
  ...
  var $sidebar_mini_checkbox  = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      ...
      $.ajax({
        url : 'theme.php',
        type : 'post',
        data : {sidebarMiniData : 'sidebar-mini'}
      });
    } else {
  ...
  var $legacy_sidebar_checkbox  = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      ...
      $.ajax({
        url : 'theme.php',
        type : 'post',
        data : {sidebarLegacyData : 'nav-legacy'}
      });
    } else {
  ...
  var $text_sm_body_checkbox  = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      ...
      $.ajax({
        url : 'theme.php',
        type : 'post',
        data : {smallBodyTextData : 'text-sm'}
      });
    } else {
  ...
  var $text_sm_header_checkbox  = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      ...
      $.ajax({
        url : 'theme.php',
        type : 'post',
        data : {smallNavbarTextData : 'text-sm'}
      });
    } else {
  ...
  var $text_sm_sidebar_checkbox  = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      ...
      $.ajax({
        url : 'theme.php',
        type : 'post',
        data : {smallSidebarTextData : 'text-sm'}
      });
    } else {
  ...
  var $text_sm_footer_checkbox  = $('<input />', {
    ...
    if ($(this).is(':checked')) {
      ...
      $.ajax({
        url : 'theme.php',
        type : 'post',
        data : {smallFooterTextData : 'text-sm'}
      });
    } else {
  ...
  function toggleDarkMode(){
    ...
    $('#dark-mode-toggle').on('click', function () {
      if ($('body').hasClass('dark-mode')) {
        ...
        $('#dark-mode-toggle i').removeClass('fas fa-sun').addClass('fas fa-moon');
      } else {
        // Enable dark mode
        $('body').addClass('dark-mode');
        localStorage.setItem('darkMode', 'enabled');
        // Change the icon to sun
        $('#dark-mode-toggle i').removeClass('fas fa-moon').addClass('fas fa-sun');
      }
    });
  }
  ...
  $(document).on('click', '.newUser', function () {
    $.ajax({
      url: '../forms/users_form.php', type: 'post', success: function (response) {
        $('#system-modal .modal-dialog').addClass('modal-lg').removeClass('modal-xl').removeClass('modal-dialog-scrollable');
  ...
  $(document).on('click', '.viewUserBtn', function () {
    var dataId = $(this).data('id');
    $.ajax({
      url: '../forms/users_view.php', type: 'post', data: {dataId: dataId}, success: function (response) {
        $('#system-modal .modal-dialog').removeClass('modal-lg').addClass('modal-xl').addClass('modal-dialog-scrollable');
  ...
  $(document).on('click', '.editUser', function () {
    var dataId = $(this).data('id');
    $.ajax({
      url: '../forms/users_form.php', type: 'post', data: {dataId: dataId}, success: function (response) {
        $('#system-modal .modal-dialog').addClass('modal-lg').removeClass('modal-xl').removeClass('modal-dialog-scrollable');
  ...
  $(document).on('click', '.deleteUser', function ()  {
    var dataId = $(this).data('id');
    $.ajax({
      url: '../forms/users_delete.php', type: 'post', data: {dataId: dataId}, success: function (response) {
        $('.systemMsg').html(response);
      }
    });
  });
  ...
  $(document).on('click', '.newExpensesCategory', function(){
    ...
    $('#system-modal .modal-body').html('<h3>Some html Content for the new category</h3>');
    $('#system-modal').modal('show');
  });
})(jQuery)
